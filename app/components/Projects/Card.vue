...
<template>
  <article
    data-card
    class="group relative flex min-h-80 flex-col overflow-hidden rounded-3xl border border-border-default bg-surface/70 p-6 shadow-[0_18px_50px_rgba(0,0,0,0.06)] backdrop-blur-xl transition-all duration-500 hover:-translate-y-1 hover:border-primary/40 hover:shadow-[0_24px_70px_rgba(255,157,0,0.14)] sm:p-8"
