      ...
      >
        ...
        >
          <div class="grid gap-4 p-4">
            <nav
              class="grid gap-2 rounded-[1.5rem] border border-border-default bg-white/5 p-2"
            >
              <NuxtLink
            ...
            <div class="grid gap-3">
              <div
                class="grid gap-3 rounded-[1.5rem] border border-border-default bg-white/5 p-3"
              >
                <div class="grid gap-2">
                  ...
                  <div class="grid grid-cols-2 gap-2">
                    ...
                    >
                      <span class="block text-xs uppercase tracking-[0.24em] opacity-70">
                        {{ lang.code }}
                      </span>
